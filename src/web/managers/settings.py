...
class SettingsManager:
    ...
    def get_settings(self) -> dict[str, Any]:
        ...
        return {
            ...
            "skip_cosmetic_drops": self._settings.skip_cosmetic_drops,
    ...
    def update_settings(self, settings_data: dict[str, Any]):
        ...
        if "skip_cosmetic_drops" in settings_data:
            self._settings.skip_cosmetic_drops = settings_data["skip_cosmetic_drops"]
