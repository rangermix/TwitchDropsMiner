    ...
    return {
        ...
        "translations": {
            ...
            "login": {
                ...
                "logged_in": _("login", "status", "logged_in"),
                "not_logged_in": _("login", "status", "logged_out"),
                "logging_in": _("login", "status", "logging_in"),
                "required": _("login", "status", "required"),
                "request": _("gui", "login", "request"),
            ...
            "settings": {
                ...
                "general": _("gui", "settings", "general"),
                "dark_mode": _("gui", "settings", "dark_mode"),
                ...
                "reload_campaigns": _("gui", "settings", "reload_campaigns"),
            ...
            "help": {
                ...
                "how_to_use_items": list(_._translation["gui"]["help"]["how_to_use_items"]),
                ...
                "features_items": list(_._translation["gui"]["help"]["features_items"]),
                "important_notes": _("gui", "help", "important_notes"),
                "important_notes_items": list(_._translation["gui"]["help"]["important_notes_items"]),
