...
collapsing, dependency-aware drop-name ignore rules with truthful ignored/skipped state,
and the claimed-drop history store with CSV export and API endpoints.
