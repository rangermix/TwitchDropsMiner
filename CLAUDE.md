...
collapsing, dependency-aware drop-name ignore rules with truthful ignored/skipped state, and
Discord webhook notifications with claim-gated reporting and secret masking.
